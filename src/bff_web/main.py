...
settings = Config()
app_configs: dict[str, Any] = {"title": "BFF-Web EDA"}
...
async def app_startup():
    global tasks
    global eventos
    task1 = asyncio.ensure_future(suscribirse_a_topico("order-created", "aeroalpes-bff", "public/default/order-created", eventos=eventos))
    tasks.append(task1)
